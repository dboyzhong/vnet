...
int main() {
    ...
    VNetLoop loop;
    shared_ptr<UdxServer> server = make_shared<UdxServer>(&loop, "127.0.0.1", 448);
    shared_ptr<UdxServer> server2 = make_shared<UdxServer>(&loop, "127.0.0.1", 449);
